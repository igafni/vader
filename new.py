...
# the table
pytesseract.pytesseract.tesseract_cmd = r'C:\Users\Itay Gafni\AppData\Local\Tesseract-OCR\tesseract.exe'
tessdata_dir_config = r'--tessdata-dir "C:\Users\Itay Gafni\AppData\Local\Tesseract-OCR\tessdata"'
...
tessdata_dir_config += ' --psm 11'
# tessdata_dir_config += ' --l ara+eng'

lang = "ara"
results = pytesseract.image_to_data(
    image,
    config=tessdata_dir_config,
    output_type=Output.DICT,lang=lang)
